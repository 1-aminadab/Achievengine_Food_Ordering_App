...
const Icon: React.FC<IconProps> = ({ from, name, size = 24, color = 'black', style, onPress, ...props }) => {
  const IconComponent = {
    Ionicons,
    FontAwesome,
    SimpleLineIcons,
  ...
  return <IconComponent name={name} size={size} color={color} style={style} onPress={onPress} {...props} />;
};
